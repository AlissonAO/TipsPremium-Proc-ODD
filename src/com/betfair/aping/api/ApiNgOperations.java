...
public abstract class ApiNgOperations {
    ...
    protected static String BET_IDS = "betIds";
    ...
    public abstract List<CurrentOrderSummary> listCurrentOrders (Set<String> betIds, Set<String> marketIds, String appKey, String ssoId) throws APINGException;
    
    public abstract CancelExecutionReport cancelerOrder (String marketId, List<CancelInstruction> instructions, String customerRef , String appKey, String ssoId) throws APINGException;
    
    public abstract ReplaceExecutionReport replaceOrders (String marketId, List<ReplaceInstruction> instructions , String customerRef, String appKey, String ssoId  ) throws APINGException;
