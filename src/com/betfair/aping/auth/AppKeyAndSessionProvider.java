package com.betfair.aping.auth;
...
public class AppKeyAndSessionProvider {
    ...
    public AppKeyAndSessionProvider() {
        this.host = "identitysso.betfair.com";;
        this.appkey = "XQzvGbEmSL9JwR7n";
        this.username = "psyalisson@gmail.com";
        this.password = "alisson1985";
